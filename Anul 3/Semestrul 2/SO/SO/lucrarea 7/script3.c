...
void insert(int rollnumber, char* name, char* phone, float percentage)
{
    ...
    if(head==NULL){
        // daca head e null
        // seteaza student ca head nou
        head = student;
    }
    else{
        // daca lista nu e goala
        // insereaza student la inceput
        student->next = head;
        head = student;
    }
...
void Delete(int rollnumber)
{
    ...
    while(temp1!=NULL){
        ...
        if(temp1->rollnumber==rollnumber){
            ...
            if(temp1==temp2){
                // conditia va rula daca
                // inregistrarea pe care dorim sa o stergem este primul nod
                // al listei
                head = head->next;
                free(temp1);
            }
            else{
                // temp1 este nodul ce trebuie sters
                // temp2 este nodul de dinainte de temp1
